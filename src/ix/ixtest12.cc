...
int testCase_12(const string &indexFileName, const Attribute &attribute)
{
	...
	// Pass: No score will be deducted.
	// Fail: score will be deducted.
	//
	// Functions tested
    // 1. Create Index
    // 2. OpenIndex
    ...
    cout << endl << "****In Test Case 12****" << endl;
...
int main()
{
	...
	RC result = testCase_12(indexFileName, attrAge);
    if (result == success) {
    	cout << "IX_Test Case 12 passed" << endl;
    	return success;
    } else {
    	cout << "IX_Test Case 12 failed. Duplicated entries were not handled properly." << endl;
    	return fail;
    }
